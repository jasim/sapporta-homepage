...
data grid the moment you create a table — the demo at the top of this page is
exactly that grid, produced by a single table declaration.

The [Sapporta Grid](https://github.com/jasim/sapporta/tree/main/packages/grid) is a custom-built React component that can be deeply composed
