---
title: "BaseGrid Interactions"
description: "Complete reference for BaseGrid cell-grid and row-list interaction modes, presets, selection shapes, runtime APIs, commands, invariants, and capabilities."
---
