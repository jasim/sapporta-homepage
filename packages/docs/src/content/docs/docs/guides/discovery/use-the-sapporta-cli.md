...
documented endpoints, performs generated row operations, calls application routes,
...
That route is illustrative, not generated by Sapporta. Use only an application
