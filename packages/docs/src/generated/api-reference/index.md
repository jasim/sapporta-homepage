...
Describes `@sapporta/shared@0.3.2`, `@sapporta/server@0.6.2`, `@sapporta/honest@0.3.14`, `@sapporta/grid@0.6.0`, `@sapporta/frontend@0.7.0`, `@sapporta/ui@0.2.15`.
...
- [@sapporta/grid/column-preset](https://sapporta.com/api-reference/grid/column-preset.md): 100 documented, split by group.
...
## @sapporta/frontend 0.7.0

- [@sapporta/frontend](https://sapporta.com/api-reference/frontend/index.md): 190 documented, 134 re-exported from subpaths, split by group.
...
- [@sapporta/frontend/report](https://sapporta.com/api-reference/frontend/report.md): 25 documented.
