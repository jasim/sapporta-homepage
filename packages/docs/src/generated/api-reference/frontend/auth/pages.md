---
title: "@sapporta/frontend/auth/pages"
package: "@sapporta/frontend"
version: "0.5.0"
specifier: "@sapporta/frontend/auth/pages"
---

> Sapporta API reference for `@sapporta/frontend@0.5.0`. Index: https://sapporta.com/api-reference/llms.txt

# @sapporta/frontend/auth/pages

Import from `@sapporta/frontend/auth/pages`. Documented from `@sapporta/frontend@0.5.0`; confirm the installed version with `node -p "require('@sapporta/frontend/package.json').version"`.
