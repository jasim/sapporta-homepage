export default [
  {
    ...
    "items": [
      ...
      {
        "label": "Build the task app",
        "items": [
          {
            "slug": "docs/getting-started/define-projects-and-tasks"
          },
          {
            "slug": "docs/getting-started/work-with-tasks-in-generated-screens"
          },
          {
            "slug": "docs/getting-started/query-tasks-through-the-generated-api"
          },
          {
            "slug": "docs/getting-started/use-the-task-app"
          }
        ]
      },
      {
        "label": "Extend the task app",
        "items": [
          {
            "slug": "docs/getting-started/apply-task-access-rules"
          },
          {
            "slug": "docs/getting-started/record-task-completion-history"
          },
          {
            "slug": "docs/getting-started/add-a-complete-task-endpoint"
          },
          {
            "slug": "docs/getting-started/call-the-workflow-from-a-typed-client"
          },
          {
            "slug": "docs/getting-started/build-a-project-progress-dashboard"
          },
          {
            "slug": "docs/getting-started/report-on-project-progress"
          },
          {
            "slug": "docs/getting-started/inspect-and-operate-the-app"
          },
          {
            "slug": "docs/getting-started/build-test-and-choose-the-next-guide"
          }
        ]
      }
    ]
  },
  {
    ...
    "items": [
      ...
      {
        "label": "Use generated application surfaces",
        "items": [
          {
